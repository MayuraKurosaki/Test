...
'    PickerMode As Integer '0=normal, 1=months, 2=years
...
Private highlightDate As Date 'check for cell to highlight in calendar
Private highlightPicker As Integer 'special value to highlight in the "my" picker
Private cHighlight As Integer       'current day that has the highlight
Private c1Highlight_Picker As Integer 'current picker highlight
...
Private Sub populateDatePicker(Optional Year As Integer, Optional Month As Integer)
    ...
    For i = 1 To 42
        ...
        If VBA.Month(trackingDate) <> Month Then
            labelDay.ForeColor = 8421504
        Else
            labelDay.ForeColor = 0
        End If
...
Private Sub setPickerMode(Mode As PickerMode)
    ...
    Select Case Mode
        ...
        Case dpMonth
            ...
            showMonthPicker
        Case dpYear
            populateYearPicker VBA.Year(This.CurrentDate)
            hideMonthPicker
            showPrevNext
            showYearPicker
    End Select
...
Private Sub process2MM(day)
    ...
    If cHighlight <> 0 Then
        ...
        If cHighlight <> day Then
            ...
            If cHighlight <= 42 Then
                'remove current highlight
                Me.Controls("LabelDay" & cHighlight).BackColor = vbWhite
                
                'check to see if its a special date
                specialHighlight Me.Controls("LabelDay" & cHighlight)
...
'                yearTitle.Font.Underline = False
    ...
    If day > 0 Then
        ...
        If day <= 42 Then
            Me.Controls("LabelDay" & day).BackColor = rgbLightSkyBlue
'        ElseIf day = 68 Then
'            'insert today button
...
Private Sub IControlEvent_OnMouseMove(Cont As MSForms.IControl, _
    ...
    Select Case True
        Case VBA.Left$(Cont.Name, 8) = "LabelDay"
'            process2MM VBA.CInt(Cont.Caption)
'            Cont.BackColor = rgbLightSkyBlue
