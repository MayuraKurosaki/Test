...
Public Declare PtrSafe Function GetObjectW Lib "gdi32" (ByVal hObject As LongPtr, ByVal nCount As Long, lpObject As Any) As Long
...
'Public Declare PtrSafe Function CreateFontIndirectW Lib "gdi32" (lpLogFont As LOGFONTW) As LongPtr
'Public Declare PtrSafe Function GetTextMetrics Lib "gdi32" Alias "GetTextMetricsA" (ByVal hdc As LongPtr, lpMetrics As TEXTMETRIC) As Long
'Public Declare PtrSafe Function GetTextMetricsW Lib "gdi32" (ByVal hdc As LongPtr, lpMetrics As TEXTMETRICW) As Long
'Public Declare PtrSafe Function GetTextFace Lib "gdi32" Alias "GetTextFaceA" (ByVal hdc As LongPtr, ByVal nCount As Long, ByVal lpFacename As String) As Long
'Public Declare PtrSafe Function GetTextFaceW Lib "gdi32" (ByVal hdc As LongPtr, ByVal nCount As Long, ByVal lpFacename As LongPtr) As Long
