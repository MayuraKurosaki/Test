...
'                    End If
'                End If
                If VBA.Replace(Cont.Name, "LabelDay", "") < .StartIndex Then
                    If .Month = 1 Then
                        .Year = .Year - 1
                    ...
                    Else
                        .Month = .Month - 1
                    End If
                ElseIf VBA.Replace(Cont.Name, "LabelDay", "") > .EndIndex Then
                    If .Month = 12 Then
                        .Year = .Year + 1
                        .PeriodStart = (.Year \ 20) * 20
                        .Month = 1
...
Private Sub MakeHolidayDictionary()
    ...
    '月日固定の祝日情報
    Call getNationalHolidayInfoMD(HolidayInfoMD, ThisWorkbook.Worksheets("List").ListObjects("T_月日固定休日"))

    '月週曜日固定の祝日情報
    Call getNationalHolidayInfoWN(HolidayInfoDOW, ThisWorkbook.Worksheets("List").ListObjects("T_月週曜日固定休日"))
