...
'        .RowSource = originalTable.DataBodyRange.Address
        .RowSource = tmpSheet.Range("A2").Resize(originalTable.ListRows.count, originalTable.ListColumns.count).Address
    End With
    Call AutoFitListbox
...
'    Debug.Print Me.ListBoxResultList.ListCount
    Me.ListBoxResultList.RowSource = tmpSheet.Range("A2").Resize(CellsCnt, originalTable.ListColumns.count).Address
'    Debug.Print Me.ListBoxResultList.ListCount
